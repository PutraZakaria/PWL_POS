               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('template/pages/layout/fixed-sidebar-custom.html') }}"
                                class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('template/pages/examples/forgot-password.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('template/pages/examples/recover-password.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('template/pages/examples/register-v2.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Register v2</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('template/pages/examples/forgot-password-v2.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('template/pages/examples/recover-password-v2.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            <div class="table-responsive">
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a
                                                    href="{{ asset('template/pages/examples/invoice.html') }}">OR9842</a>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a
                                                    href="{{ asset('template/pages/examples/invoice.html') }}">OR1848</a>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a
                                                    href="{{ asset('template/pages/examples/invoice.html') }}">OR7429</a>
                                            </td>
                                            <td>iPhone 6 Plus</td>
